...
# Using only DAF final data from API as an input            #
...
tableau.combined.long <- tableau.combined %>%
  ...
  mutate(as_of_date = '2018-01-02')

write.csv(tableau.combined.long, 'views/DAC_Combined_Interactive_jan2draft.csv', row.names = FALSE)
